...
#        for bearings in [True, False]:
    
    #extract inputs & labels from the data set
    test_fire = 'Woolsey'
    X_train,y_train = extract_data(fires[fires["Fire Name"]!=test_fire], with_bearings=True)
    X_test,y_test = extract_data(fires[fires["Fire Name"]==test_fire], with_bearings=True)
